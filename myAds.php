...
if (isset($_SESSION['username'])) {
    ...
    if ($action == 'manage') {
                      ...
                      <?php echo $ad['publish_state'] ?>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <div class="button-group">
                                            <small>Edit</small>
                                            <a href="myAds.php?action=edit&adid=<?php echo $ad['id'] ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc" id="desc" class="form-control mt-1"
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone_number" id="phone_number"
                                               class="form-control mt-1" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <div class="form-group">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            $adImgName = 'olx-ad' . rand(0, rand(0, 99999999) * 300) * 999 . $adImgName;
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <div class="form-group">
                                            <label for="title">Title</label>
                                            <input type="text" name="title" id="title" class="form-control mt-1"
                                                   placeholder="Title" value="<?php echo $ad['title'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc" id="desc" class="form-control mt-1"
                                                      ...
                                                      rows="10"><?php echo $ad['description'] ?></textarea>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone_number" id="phone_number"
                                                   class="form-control mt-1" placeholder="Phone Number"
                                                   value="<?php echo $ad['phone_number'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
